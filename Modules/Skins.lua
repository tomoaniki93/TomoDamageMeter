...
ns.SKINS = {
    {
        ...
        bg          = { 0.00, 0.00, 0.00 }, bgAlpha = 0.84,
        headerBg    = { 0.055, 0.055, 0.065, 1.00 },
        headerHover = { 0.45, 0.035, 0.075, 0.34 },
        border      = { 0.28, 0.28, 0.31, 0.78 },
        scrollThumb = { 0.64, 0.08, 0.15 },
        accent      = { 0.88, 0.08, 0.18 },
        textPrimary = { 1.00, 1.00, 1.00 },
        textSecondary = { 0.66, 0.66, 0.69 },
        textMuted   = { 0.46, 0.46, 0.50 },
        textLabel   = { 0.82, 0.82, 0.84 },
