...
L["SETTINGS_DASHBOARD"] = "Tableau de bord"
L["SETTINGS_DASHBOARD_DESC"] = "État et commandes rapides de TomoDamageMeter."
L["SETTINGS_STATUS"] = "État"
L["SETTINGS_QUICK_ACTIONS"] = "Actions rapides"
L["SETTINGS_METERS"] = "Compteurs"
L["SETTINGS_VISIBLE"] = "Visibles"
L["SETTINGS_HIDDEN"] = "Masqués"
L["SETTINGS_SHOW_METERS"] = "Afficher les compteurs"
L["SETTINGS_HIDE_METERS"] = "Masquer les compteurs"
L["SETTINGS_ACTIVE_WINDOWS"] = "Fenêtres actives"
L["SETTINGS_ACTIVE_SKIN"] = "Skin actif"
L["SETTINGS_WINDOW_OVERVIEW"] = "Aperçu des fenêtres"
L["SETTINGS_WINDOWS_DESC"] = "Créez et configurez jusqu'à cinq fenêtres de compteur indépendantes."
L["SETTINGS_APPEARANCE_DESC"] = "Style du HUD. Le panneau conserve l'identité rouge/blanc TDM."
L["SETTINGS_MINIMAP"] = "Minimap"
L["SETTINGS_MINIMAP_DESC"] = "Contrôlez le bouton minimap TDM et sa position."
L["SETTINGS_MINIMAP_BUTTON"] = "Bouton minimap"
L["SETTINGS_MINIMAP_SHOW"] = "Afficher le bouton minimap"
L["SETTINGS_MINIMAP_SCALE"] = "Échelle du bouton"
L["SETTINGS_MINIMAP_HELP"] = "Clic gauche : ouvrir TDM. Clic droit : actions rapides. Faites glisser le bouton autour de la minimap pour le déplacer."
L["SETTINGS_MINIMAP_RESTORE"] = "Restaurer le bouton"
L["SETTINGS_MINIMAP_TOGGLE_METERS"] = "Afficher / Masquer les compteurs"
L["SETTINGS_ADDON_COMPARTMENT"] = "Compartiment des addons"
L["SETTINGS_ADDON_COMPARTMENT_DESC"] = "TDM apparaît aussi dans le compartiment des addons de Blizzard, afin de rester accessible même si le bouton minimap est masqué."
L["MINIMAP_OPEN_SETTINGS"] = "Ouvrir les options"
L["MINIMAP_HIDE_METERS"] = "Masquer les compteurs"
L["MINIMAP_SHOW_METERS"] = "Afficher les compteurs"
L["MINIMAP_UNLOCK_ALL"] = "Tout déverrouiller"
L["MINIMAP_LOCK_ALL"] = "Tout verrouiller"
L["MINIMAP_RESET_DATA"] = "Réinitialiser les données"
L["MINIMAP_HIDE_BUTTON"] = "Masquer le bouton minimap"
L["MINIMAP_TOOLTIP_LEFT"] = "Clic gauche : ouvrir les options"
L["MINIMAP_TOOLTIP_RIGHT"] = "Clic droit : actions rapides"
L["MINIMAP_TOOLTIP_DRAG"] = "Glisser : déplacer autour de la minimap"
L["SETTINGS_GENERAL"] = "Général"
L["SETTINGS_APPEARANCE"] = "Apparence"
L["SETTINGS_SKIN"] = "Skin"
L["SETTINGS_BAR_TEXTURE"] = "Texture des barres"
L["SKIN_DARK"] = "TDM Rouge"
