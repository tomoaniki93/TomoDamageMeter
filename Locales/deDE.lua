...
L["SETTINGS_DASHBOARD"] = "Übersicht"
L["SETTINGS_DASHBOARD_DESC"] = "Status und Schnellsteuerung für TomoDamageMeter."
L["SETTINGS_STATUS"] = "Status"
L["SETTINGS_QUICK_ACTIONS"] = "Schnellaktionen"
L["SETTINGS_METERS"] = "Meter"
L["SETTINGS_VISIBLE"] = "Sichtbar"
L["SETTINGS_HIDDEN"] = "Ausgeblendet"
L["SETTINGS_SHOW_METERS"] = "Meter anzeigen"
L["SETTINGS_HIDE_METERS"] = "Meter ausblenden"
L["SETTINGS_ACTIVE_WINDOWS"] = "Aktive Fenster"
L["SETTINGS_ACTIVE_SKIN"] = "Aktiver Skin"
L["SETTINGS_WINDOW_OVERVIEW"] = "Fensterübersicht"
L["SETTINGS_WINDOWS_DESC"] = "Bis zu fünf unabhängige Meter-Fenster erstellen und konfigurieren."
L["SETTINGS_APPEARANCE_DESC"] = "HUD-Stil. Das Einstellungsfenster behält die rot/weiße TDM-Identität."
L["SETTINGS_MINIMAP"] = "Minimap"
L["SETTINGS_MINIMAP_DESC"] = "TDM-Minimap-Schaltfläche und Position steuern."
L["SETTINGS_MINIMAP_BUTTON"] = "Minimap-Schaltfläche"
L["SETTINGS_MINIMAP_SHOW"] = "Minimap-Schaltfläche anzeigen"
L["SETTINGS_MINIMAP_SCALE"] = "Schaltflächengröße"
L["SETTINGS_MINIMAP_HELP"] = "Linksklick öffnet TDM. Rechtsklick zeigt Schnellaktionen. Ziehen verschiebt die Schaltfläche um die Minimap."
L["SETTINGS_MINIMAP_RESTORE"] = "Schaltfläche wiederherstellen"
L["SETTINGS_MINIMAP_TOGGLE_METERS"] = "Meter anzeigen / ausblenden"
L["SETTINGS_ADDON_COMPARTMENT"] = "Addon-Fach"
L["SETTINGS_ADDON_COMPARTMENT_DESC"] = "TDM erscheint auch im Blizzard Addon-Fach und bleibt erreichbar, wenn die Minimap-Schaltfläche verborgen ist."
L["MINIMAP_OPEN_SETTINGS"] = "Einstellungen öffnen"
L["MINIMAP_HIDE_METERS"] = "Meter ausblenden"
L["MINIMAP_SHOW_METERS"] = "Meter anzeigen"
L["MINIMAP_UNLOCK_ALL"] = "Alle entsperren"
L["MINIMAP_LOCK_ALL"] = "Alle sperren"
L["MINIMAP_RESET_DATA"] = "Kampfdaten zurücksetzen"
L["MINIMAP_HIDE_BUTTON"] = "Minimap-Schaltfläche ausblenden"
L["MINIMAP_TOOLTIP_LEFT"] = "Linksklick: Einstellungen"
L["MINIMAP_TOOLTIP_RIGHT"] = "Rechtsklick: Schnellaktionen"
L["MINIMAP_TOOLTIP_DRAG"] = "Ziehen: um die Minimap bewegen"
...
L["FONT_GAME_DEFAULT"] = "Spielstandard"
