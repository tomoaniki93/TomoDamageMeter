...
L["SETTINGS_DASHBOARD_DESC"] = "Stato e controlli rapidi di TomoDamageMeter."
L["SETTINGS_STATUS"] = "Stato"
L["SETTINGS_QUICK_ACTIONS"] = "Azioni rapide"
L["SETTINGS_METERS"] = "Misuratori"
L["SETTINGS_VISIBLE"] = "Visibili"
L["SETTINGS_HIDDEN"] = "Nascosti"
L["SETTINGS_SHOW_METERS"] = "Mostra misuratori"
L["SETTINGS_HIDE_METERS"] = "Nascondi misuratori"
L["SETTINGS_ACTIVE_WINDOWS"] = "Finestre attive"
L["SETTINGS_ACTIVE_SKIN"] = "Skin attiva"
L["SETTINGS_WINDOW_OVERVIEW"] = "Panoramica finestre"
L["SETTINGS_WINDOWS_DESC"] = "Crea e configura fino a cinque finestre indipendenti."
L["SETTINGS_APPEARANCE_DESC"] = "Stile HUD. Il pannello mantiene l'identità TDM rosso/bianco."
L["SETTINGS_MINIMAP"] = "Minimappa"
L["SETTINGS_MINIMAP_DESC"] = "Controlla il pulsante minimappa TDM e la sua posizione."
L["SETTINGS_MINIMAP_BUTTON"] = "Pulsante minimappa"
L["SETTINGS_MINIMAP_SHOW"] = "Mostra pulsante minimappa"
L["SETTINGS_MINIMAP_SCALE"] = "Scala pulsante"
L["SETTINGS_MINIMAP_HELP"] = "Clic sinistro apre TDM. Clic destro apre le azioni rapide. Trascina il pulsante attorno alla minimappa per spostarlo."
L["SETTINGS_MINIMAP_RESTORE"] = "Ripristina pulsante"
L["SETTINGS_MINIMAP_TOGGLE_METERS"] = "Mostra / Nascondi misuratori"
L["SETTINGS_ADDON_COMPARTMENT"] = "Comparto addon"
L["SETTINGS_ADDON_COMPARTMENT_DESC"] = "TDM appare anche nel comparto addon di Blizzard e resta accessibile se il pulsante minimappa è nascosto."
L["MINIMAP_OPEN_SETTINGS"] = "Apri impostazioni"
L["MINIMAP_HIDE_METERS"] = "Nascondi misuratori"
L["MINIMAP_SHOW_METERS"] = "Mostra misuratori"
L["MINIMAP_UNLOCK_ALL"] = "Sblocca tutto"
L["MINIMAP_LOCK_ALL"] = "Blocca tutto"
L["MINIMAP_RESET_DATA"] = "Reimposta dati di combattimento"
L["MINIMAP_HIDE_BUTTON"] = "Nascondi pulsante minimappa"
L["MINIMAP_TOOLTIP_LEFT"] = "Clic sinistro: apri impostazioni"
L["MINIMAP_TOOLTIP_RIGHT"] = "Clic destro: azioni rapide"
L["MINIMAP_TOOLTIP_DRAG"] = "Trascina: sposta attorno alla minimappa"
L["SETTINGS_GENERAL"]           = "Generale"
L["SETTINGS_APPEARANCE"]        = "Aspetto"
L["SETTINGS_SKIN"] = "Skin"
L["SETTINGS_BAR_TEXTURE"] = "Texture barre"
L["SKIN_DARK"] = "TDM Rosso"
...
L["FONT_GAME_DEFAULT"] = "Predefinito del gioco"
