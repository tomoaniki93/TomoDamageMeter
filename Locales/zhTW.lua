...
L["SETTINGS_DASHBOARD"] = "儀表板"
L["SETTINGS_DASHBOARD_DESC"] = "TomoDamageMeter 的狀態與快速控制。"
L["SETTINGS_STATUS"] = "狀態"
L["SETTINGS_QUICK_ACTIONS"] = "快速操作"
L["SETTINGS_METERS"] = "統計視窗"
L["SETTINGS_VISIBLE"] = "顯示"
L["SETTINGS_HIDDEN"] = "隱藏"
L["SETTINGS_SHOW_METERS"] = "顯示統計視窗"
L["SETTINGS_HIDE_METERS"] = "隱藏統計視窗"
L["SETTINGS_ACTIVE_WINDOWS"] = "作用中視窗"
L["SETTINGS_ACTIVE_SKIN"] = "目前樣式"
L["SETTINGS_WINDOW_OVERVIEW"] = "視窗概覽"
L["SETTINGS_WINDOWS_DESC"] = "建立並設定最多五個獨立統計視窗。"
L["SETTINGS_APPEARANCE_DESC"] = "HUD 外觀。設定面板維持 TDM 紅白視覺風格。"
L["SETTINGS_MINIMAP"] = "小地圖"
L["SETTINGS_MINIMAP_DESC"] = "控制 TDM 小地圖按鈕及其位置。"
L["SETTINGS_MINIMAP_BUTTON"] = "小地圖按鈕"
L["SETTINGS_MINIMAP_SHOW"] = "顯示小地圖按鈕"
L["SETTINGS_MINIMAP_SCALE"] = "按鈕縮放"
L["SETTINGS_MINIMAP_HELP"] = "左鍵開啟 TDM，右鍵開啟快速操作。拖曳按鈕可沿小地圖四周移動。"
L["SETTINGS_MINIMAP_RESTORE"] = "還原按鈕"
L["SETTINGS_MINIMAP_TOGGLE_METERS"] = "顯示 / 隱藏統計視窗"
L["SETTINGS_ADDON_COMPARTMENT"] = "插件收納選單"
L["SETTINGS_ADDON_COMPARTMENT_DESC"] = "TDM 也會顯示在暴雪插件收納選單中，即使隱藏小地圖按鈕仍可開啟設定。"
L["MINIMAP_OPEN_SETTINGS"] = "開啟設定"
L["MINIMAP_HIDE_METERS"] = "隱藏統計視窗"
L["MINIMAP_SHOW_METERS"] = "顯示統計視窗"
L["MINIMAP_UNLOCK_ALL"] = "全部解鎖"
L["MINIMAP_LOCK_ALL"] = "全部鎖定"
L["MINIMAP_RESET_DATA"] = "重設戰鬥資料"
L["MINIMAP_HIDE_BUTTON"] = "隱藏小地圖按鈕"
L["MINIMAP_TOOLTIP_LEFT"] = "左鍵：開啟設定"
L["MINIMAP_TOOLTIP_RIGHT"] = "右鍵：快速操作"
L["MINIMAP_TOOLTIP_DRAG"] = "拖曳：沿小地圖移動"
