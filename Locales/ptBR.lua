...
L["SETTINGS_DASHBOARD"] = "Painel"
L["SETTINGS_DASHBOARD_DESC"] = "Status e controles rápidos do TomoDamageMeter."
L["SETTINGS_STATUS"] = "Status"
L["SETTINGS_QUICK_ACTIONS"] = "Ações rápidas"
L["SETTINGS_METERS"] = "Medidores"
L["SETTINGS_VISIBLE"] = "Visíveis"
L["SETTINGS_HIDDEN"] = "Ocultos"
L["SETTINGS_SHOW_METERS"] = "Mostrar medidores"
L["SETTINGS_HIDE_METERS"] = "Ocultar medidores"
L["SETTINGS_ACTIVE_WINDOWS"] = "Janelas ativas"
L["SETTINGS_ACTIVE_SKIN"] = "Skin ativa"
L["SETTINGS_WINDOW_OVERVIEW"] = "Visão geral das janelas"
L["SETTINGS_WINDOWS_DESC"] = "Crie e configure até cinco janelas independentes."
L["SETTINGS_APPEARANCE_DESC"] = "Estilo do HUD. O painel mantém a identidade TDM vermelha/branca."
L["SETTINGS_MINIMAP"] = "Minimapa"
L["SETTINGS_MINIMAP_DESC"] = "Controle o botão do minimapa do TDM e sua posição."
L["SETTINGS_MINIMAP_BUTTON"] = "Botão do minimapa"
L["SETTINGS_MINIMAP_SHOW"] = "Mostrar botão do minimapa"
L["SETTINGS_MINIMAP_SCALE"] = "Escala do botão"
L["SETTINGS_MINIMAP_HELP"] = "Clique esquerdo abre o TDM. Clique direito abre ações rápidas. Arraste o botão ao redor do minimapa para mover."
L["SETTINGS_MINIMAP_RESTORE"] = "Restaurar botão"
L["SETTINGS_MINIMAP_TOGGLE_METERS"] = "Mostrar / Ocultar medidores"
L["SETTINGS_ADDON_COMPARTMENT"] = "Compartimento de addons"
L["SETTINGS_ADDON_COMPARTMENT_DESC"] = "O TDM também aparece no compartimento de addons da Blizzard e continua acessível se o botão do minimapa estiver oculto."
...
L["MINIMAP_UNLOCK_ALL"] = "Desbloquear tudo"
L["MINIMAP_LOCK_ALL"] = "Bloquear tudo"
L["MINIMAP_RESET_DATA"] = "Redefinir dados de combate"
L["MINIMAP_HIDE_BUTTON"] = "Ocultar botão do minimapa"
L["MINIMAP_TOOLTIP_LEFT"] = "Clique esquerdo: abrir configurações"
L["MINIMAP_TOOLTIP_RIGHT"] = "Clique direito: ações rápidas"
L["MINIMAP_TOOLTIP_DRAG"] = "Arrastar: mover ao redor do minimapa"
L["SETTINGS_GENERAL"]           = "Geral"
L["SETTINGS_APPEARANCE"]        = "Aparência"
L["SETTINGS_SKIN"] = "Skin"
L["SETTINGS_BAR_TEXTURE"] = "Textura das barras"
L["SKIN_DARK"] = "TDM Vermelho"
