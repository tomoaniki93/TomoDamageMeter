...
L["SETTINGS_DASHBOARD"] = "仪表板"
L["SETTINGS_DASHBOARD_DESC"] = "TomoDamageMeter 的状态与快捷控制。"
L["SETTINGS_STATUS"] = "状态"
L["SETTINGS_QUICK_ACTIONS"] = "快捷操作"
L["SETTINGS_METERS"] = "统计窗口"
L["SETTINGS_VISIBLE"] = "显示"
L["SETTINGS_HIDDEN"] = "隐藏"
L["SETTINGS_SHOW_METERS"] = "显示统计窗口"
L["SETTINGS_HIDE_METERS"] = "隐藏统计窗口"
L["SETTINGS_ACTIVE_WINDOWS"] = "活动窗口"
L["SETTINGS_ACTIVE_SKIN"] = "当前皮肤"
L["SETTINGS_WINDOW_OVERVIEW"] = "窗口概览"
L["SETTINGS_WINDOWS_DESC"] = "创建并配置最多五个独立统计窗口。"
L["SETTINGS_APPEARANCE_DESC"] = "HUD 外观。设置面板保持 TDM 红白视觉风格。"
L["SETTINGS_MINIMAP"] = "小地图"
L["SETTINGS_MINIMAP_DESC"] = "控制 TDM 小地图按钮及其位置。"
L["SETTINGS_MINIMAP_BUTTON"] = "小地图按钮"
L["SETTINGS_MINIMAP_SHOW"] = "显示小地图按钮"
L["SETTINGS_MINIMAP_SCALE"] = "按钮缩放"
L["SETTINGS_MINIMAP_HELP"] = "左键打开 TDM，右键打开快捷操作。拖动按钮可沿小地图四周移动。"
L["SETTINGS_MINIMAP_RESTORE"] = "恢复按钮"
L["SETTINGS_MINIMAP_TOGGLE_METERS"] = "显示 / 隐藏统计窗口"
L["SETTINGS_ADDON_COMPARTMENT"] = "插件收纳菜单"
L["SETTINGS_ADDON_COMPARTMENT_DESC"] = "TDM 也会显示在暴雪插件收纳菜单中，即使隐藏小地图按钮仍可打开设置。"
L["MINIMAP_OPEN_SETTINGS"] = "打开设置"
L["MINIMAP_HIDE_METERS"] = "隐藏统计窗口"
L["MINIMAP_SHOW_METERS"] = "显示统计窗口"
L["MINIMAP_UNLOCK_ALL"] = "全部解锁"
L["MINIMAP_LOCK_ALL"] = "全部锁定"
L["MINIMAP_RESET_DATA"] = "重置战斗数据"
L["MINIMAP_HIDE_BUTTON"] = "隐藏小地图按钮"
L["MINIMAP_TOOLTIP_LEFT"] = "左键：打开设置"
L["MINIMAP_TOOLTIP_RIGHT"] = "右键：快捷操作"
L["MINIMAP_TOOLTIP_DRAG"] = "拖动：沿小地图移动"
